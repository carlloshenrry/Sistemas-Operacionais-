 ...
 *                instante exato em que alguma acao vai ocorrer, ocorre o
 *problema do desvio. A medicao de tempo e imprecisa. Similarmente, o tempo que
 *demora o retorno da chamada sleep tambem e impreciso. Ao longo do tempo, isto
 *ocasionara um desvio de tempo. Algo como se um relogio perdesse um segundo a
 *cada dia. Ao longo de um dia, essa diferenca e insignificante, mas, ao longo
 *de um ano, sao perdidos 365 segundos, o que e superior a 6 minutos. Este e um
 *                exemplo de desvio.
 *
 *******************************************************************************/
...
/*
 * Pergunta 1: o que o compilador gcc faz com o arquivo .h, cujo nome aparece
 * ap�s o include?
 */
...
/*
 * Pergunta 3: qual eh a funcao da diretiva include (linha que come�a com #),
 * com rela��o ao compilador?
 */
